...
class Restormer(nn.Module):
    def __init__(self,
        ...
        # content disentanglement module
    ...
    def forward(self, img, ms_dct_feats, dct_align_score, ocr_mask, img_size):
        ...
        out_enc_level1 = self.encoder_level1(inp_enc_level1)  # dim * 2 ** 0
        ...
        out_enc_level2 = self.encoder_level2(inp_enc_level2)  # dim * 2 ** 1
        ...
        out_enc_level3 = self.encoder_level3(inp_enc_level3)  # dim * 2 ** 2
        ...
        latent = self.latent(inp_enc_level4)  # dim * 2 ** 3
...
class RestormerDec(nn.Module):
    def __init__(self,
        ...
        super(RestormerDec, self).__init__()
    ...
    def spatial_shuffle(self, f):
        b, c, h, w = f.shape
        f = f.view(b, c, h * w)
        f = f[:, :, torch.randperm(h * w)]
        f = f.view(b, c, h, w)
        return f


def get_restormer(model_name, out_channels=None):
